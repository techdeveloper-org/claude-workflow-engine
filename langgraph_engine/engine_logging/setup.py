...
Renamed from logging_setup.py -> engine_logging/setup.py (v1.20.0).
"""
...
class ExecutionLogger:
    ...
    def __init__(self, session_dir: Path):
        ...
        Args:
            session_dir: Path to the session directory for log storage.
        """
...
def setup_logger(session_dir: Path, session_id: str) -> ExecutionLogger:
    ...
    Returns:
        Ready-to-use ExecutionLogger instance.
    """
