...
Usage (standalone):
    python code_graph_analyzer.py /path/to/project [session_id] [tech_stack_csv]
...
def _cli_main(args: List[str]) -> None:
    ...
    Usage:
        python code_graph_analyzer.py <project_path> [session_id] [tech_stack_csv]
    """
    if len(args) < 1:
        print("Usage: code_graph_analyzer.py <project_path> [session_id] [tech_stack_csv]")
        sys.exit(1)
