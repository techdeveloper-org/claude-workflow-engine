"""Level 1 Sync - Complexity Calculation node.

Canonical location: langgraph_engine/level1_sync/complexity_calculator.py
...
# Conditional import for calculate_complexity
try:
...
def node_complexity_calculation(state):
