# -*- coding: utf-8 -*-
"""
context-monitor.py - Level 1 Sync System: Context Window Usage Monitor
...
Usage:
    python context-monitor.py                     # Estimate context from default session dir
    python context-monitor.py <session_dir>       # Estimate context from specific dir
    python context-monitor.py --json              # Output as JSON
...
def main() -> int:
    """CLI entry point for context-monitor.py."""
