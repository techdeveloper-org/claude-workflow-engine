# -*- coding: utf-8 -*-
"""
pattern-detector.py - Level 1 Sync System: Technology Pattern Detector
...
Usage:
    python pattern-detector.py                      # Detect patterns in current dir
    python pattern-detector.py <project_root>       # Detect patterns in given dir
    python pattern-detector.py --json               # Output as JSON
    python pattern-detector.py --all-projects       # Scan all projects
...
def main() -> int:
    """CLI entry point for pattern-detector.py."""
