...
flowchart TD
    ...
    MG["Merge Node\nLinear-scale simple score → [1-25]\n`combined_complexity_score`\n= simple×0.3 + graph×0.7\nResult stored in state"]
...
## 4. Level 3 · Execution — Pre-0 + Step 0 Detail
...
timeline
    ...
    v1.14.0 : 8 active steps  : 2 subprocess calls (claude CLI) : ~15s planning : Step 0 = template fill + orchestrator
...
*Generated from `CLAUDE.md` · Rendered by GitHub / VS Code Markdown preview with Mermaid support*
